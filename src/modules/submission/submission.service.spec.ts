...
//             const formResponse = [{ questionId: 1, response: 'Answer 1' }];
//             const question = { id: 1, questionDescription: 'Question 1' };
//             (Question.findByPk as jest.Mock).mockResolvedValueOnce(question);

//             const result = await submissionService.formatSubmission(formResponse);

//             expect(result).toEqual([{ questionId: 1, text: 'Question 1', response: 'Answer 1' }]);
//         });
//     });
...
//             (submissionService.formatSubmission as jest.Mock).mockResolvedValueOnce([
//                 { questionId: 1, text: 'Question 1', response: 'Answer 1' }
//             ]);

//             // Call the formatSubmissionData method
...
//                 submissionId: 1,
//                 formId: 1,
//                 questions: [{ questionId: 1, text: 'Question 1', response: 'Answer 1' }]
//             });
//         });
//     });
